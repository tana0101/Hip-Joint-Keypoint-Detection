...
from timm.layers import trunc_normal_, DropPath     # CHANGED
from timm.models.registry import register_model
from timm.layers import to_2tuple                   # NEW

def checkpoint_seq(modules, x):
    # 將 from timm.models.helpers import checkpoint_seq 取代成 torch 內建的 checkpoint_sequential
    # 需要將 checkpoint_seq 的參數 segments 設為 1，才能達到相同效果
    return torch.utils.checkpoint.checkpoint_sequential(modules, segments=1, input=x)
